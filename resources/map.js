...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1Ijoic2VscGhpcm9uIiwiYSI6ImNsZmxhNjAzdjAzNTQzcm8zMHprbnNxMXMifQ.8hHztfebhj7yzdkYHLBdKQ', {
    maxZoom: 18,
